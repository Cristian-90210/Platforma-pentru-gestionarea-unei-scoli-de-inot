...
export const Landing: React.FC = () => {
    ...
    return (
        <div ref={revealRef} className="animate-in fade-in duration-500">
            ...
            <div className="py-20 bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800">
            ...
            <div className="py-20 bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800">
                <div className="container mx-auto px-6">
                    <div className="scroll-reveal reveal-up text-center mb-16">
                        <h2 className="text-3xl font-bold text-gray-800 dark:text-white mb-4 uppercase tracking-wide">
            ...
            {/* CTA Section */}
            <div className="py-20 bg-host-gradient relative overflow-hidden">
                <div className="absolute inset-0">
                    <div className="absolute top-[-20%] left-[-10%] w-[40%] h-[40%] bg-blue-600/20 rounded-full filter blur-3xl animate-blob" />
                    <div className="absolute bottom-[-20%] right-[-10%] w-[40%] h-[40%] bg-cyan-600/20 rounded-full filter blur-3xl animate-blob animation-delay-2000" />
                </div>
